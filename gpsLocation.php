...
<body class="gps">
    <div class="gps__container">
        <h1 class="h1__xl">Hi <?php echo $username['name'] ?>,<br>Welcome
            to <br>Home<span class="green">Grown</span> </h1>
        <p>Please allow GPS Functions for Homegrown to find communities near you.</p>
