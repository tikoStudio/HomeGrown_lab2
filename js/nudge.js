...
let sendNudgeButton = document.querySelector('.nudge__popup__send').addEventListener("click", (e) => {
  document.querySelector('.nudge__popup').style.display="none"
  document.querySelector('.nudge__complete').style.display="block"
})

let nudgeComplete = document.querySelector('.nudge__complete').addEventListener("click", (e) => {
  document.querySelector('.blur').style.display="none"
  document.querySelector('.nudge__complete').style.display="none"
})

let blur = document.querySelector('.blur').addEventListener("click", (e) => {
  document.querySelector('.blur').style.display="none"
  document.querySelector('.nudge__popup').style.display="none"
  document.querySelector('.nudge__complete').style.display="none"
})